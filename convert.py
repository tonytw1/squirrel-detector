...
# Convert the model
converter = tf.lite.TFLiteConverter.from_saved_model('models/squirrelnet_ssd_mobilenet_v2_320x320_coco17_tpu-8/tflite/saved_model') # path to the SavedModel directory
...
TF_LITE_MODEL_PATH = 'models/squirrelnet_ssd_mobilenet_v2_320x320_coco17_tpu-8/tflite/squirrelnet.tflite'
...
TF_LITE_LABEL_PATH = 'models/squirrelnet_ssd_mobilenet_v2_320x320_coco17_tpu-8/tflite/squirrelnet_label_map.txt'
...
writer_utils.save_file(writer.populate(), 'models/squirrelnet_ssd_mobilenet_v2_320x320_coco17_tpu-8/tflite/squirrelnet-normalised.tflite')
print("Done")
